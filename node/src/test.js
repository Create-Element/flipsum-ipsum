...
const ipsumTests = {
	...
	arrayTest: () => {
		...
		return new Promise((resolve, reject) => {
			flipsumIpsum.generateArray(TEST_IPSUM_SLUG, TEST_PARAGRAPH_COUNT)
				.then((paragraphs) => {
	...
	htmlTest: () => {
		...
		return new Promise((resolve, reject) => {
			flipsumIpsum.generateHtml(TEST_IPSUM_SLUG, TEST_PARAGRAPH_COUNT)
				.then((paragraphs) => {
	...
	getIpsumMetaTest: () => {
		...
		return new Promise((resolve, reject) => {
			flipsumIpsum.getIpsumMeta(TEST_IPSUM_SLUG)
				.then((ipsumMeta) => {
